package com.api.educationalsystem.utils;
...
public class JWTUtils {
    ...
    public static String generateToken(Date exp, Map<String, Object> data) {
    ...
    public static boolean checkToken(String token, Integer id) {
        ...
        UserDTO userDTO = JWTUtils.getDataFromToken(token, "user", UserDTO.class);
